...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        //Please set the opening time to be before than current time and closing time to after the current time.
        LocalTime newOpeningTime = LocalTime.parse("09:00:00");
